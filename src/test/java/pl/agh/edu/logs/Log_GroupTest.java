...
class Log_GroupTest {
    ...
    void addTest(){
        ...
        Log_Group my_log =  new Log_Group(my_group);
        Log_Group my_log_2 = new Log_Group(my_group);
        ...
        List<Log_Group> my_logs = session.createQuery(
                "from pl.agh.edu.logs.Log_Group", Log_Group.class).getResultList();
    ...
    void removeTest(){
        ...
        my_group.removeLog_Group(my_log);
